      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
          ...
          <div className="">
            ...
            <div className="flex flex-col sm:flex-row">
              <div className="relative flex-shrink-0 sm:w-7/12">
                <input type="text" id="billing-address" name="billing-address" className="w-full rounded-md border border-gray-200 py-3 px-4 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street Address" />
                {/* <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
            ...
            <form className="my-5 grid gap-6">
              <div className="relative">
        ...
        <div className="px-4 pt-8">
          ...
          {cartItems.map((product) => {
            return (
              <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                <img className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={product.thumbnail} alt={product.title} />
          ...
          <div className="mt-6 border-t border-b py-2">
            ...
            <button className="mt-4 mb-8 w-full rounded-md bg-[#e74c3c] px-6 py-3 font-medium text-white">Place Order</button>
          </div>
      </div>
    </>
  );
