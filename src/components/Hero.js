...
const Hero = () => {
  ...
  return (
        ...
        <div className="container p-6 mx-auto">
            <a className="block text-2xl font-bold text-center text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Wigui Store</a>
            ...
            <div className="flex items-center justify-center mt-6 text-gray-600 capitalize dark:text-gray-300">
                ...
                <a href="#" className="border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-500 mx-1.5 sm:mx-6">Articles</a>
    ...
    <div className="container flex flex-col-reverse px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
        <div className="flex flex-col items-center w-full lg:flex-row lg:w-1/2">
            <div className="max-w-lg lg:mx-12 lg:order-2">
                <h1 className="text-3xl font-semibold tracking-wide text-gray-800 dark:text-white lg:text-4xl">The best Place to order online</h1>
                ...
                <div className="mt-6">
                    <a href="#" className="px-6 py-3 mt-6 text-sm font-medium leading-5 text-center text-white capitalize bg-blue-600 rounded-full hover:bg-blue-500 lg:mx-0 lg:w-auto focus:outline-none">Start Shopping</a>
                </div>
            </div>
        </div>

        <div className="flex items-center absolute right-20 justify-center w-96 h-96 white lg:w-96 float-right rounded-full" />
