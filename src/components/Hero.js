...
const Hero = () => {
  ...
  const product = useSelector((state) => state.products.find((product) => product.id == 17)); // eslint-disable-line eqeqeq
  ...
  <div className="container flex flex-col-reverse px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
      ...
      {/* <div className="flex items-center absolute right-20 justify-center w-96 h-96 bg-sky-500 lg:w-96 float-right rounded-full" /> */}
